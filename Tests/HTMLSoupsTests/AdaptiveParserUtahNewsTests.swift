...
final class AdaptiveParserUtahNewsTests: XCTestCase {
    ...
    func testKUTVDynamicContent() async throws {
        let url = URL(string: "https://kutv.com/news/2news-investigates/radio-interference-big-buildings-pay-their-way-for-new-utah-communications-system")!
        ...
        print("Content preview: \(String(article.textContent?.prefix(200) ?? "") + "...")")
