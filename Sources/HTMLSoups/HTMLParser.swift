...
public class HTMLParser {
    ...
    private func mergeDynamicContent(into document: inout Document, from dynamicDoc: Document) throws {
    ...
    public func extractAttribute(from document: Document, selector: String, attribute: String) throws -> String {
        guard let element = try document.select(selector).first() else {
            throw HTMLParsingError.elementNotFound(selector)
        }
